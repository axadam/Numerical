...
public func halleyRoot(guess: Double, xmin: Double? = nil, xmax: Double? = nil, maxIter: Int = 100, xtol: Double = 1e-10, f: (Double) -> Double, f1: (Double) -> Double, f2: (Double) -> Double) -> Double {
...
///
/// Numerical Recipes §9.4.2
public func halleyRoot(guess: Double, xmin: Double? = nil, xmax: Double? = nil, maxIter: Int = 100, xtol: Double = 1e-10, f: (Double) -> Double, f1: (Double) -> Double, f2f1: (Double) -> Double) -> Double {
    return rootHelper(guess: guess, xmin: xmin, xmax: xmax, maxIter: maxIter, xtol: xtol) { x0 in
