...
final class SpecialFunctionsTests: XCTestCase {
    ...
    func testMarcumBigMu() {
        ...
        let ystr = "\(y)"
        AssertLRE(marcum_inverse(µ: µ, x: x(0.01), p: .q(1.9845278031193e-4)), ystr, exact: true, digits: 9.5, resultStore: rs, table: t, testCase: "x:0.01µ", field: f1)
        AssertLRE(marcum_inverse(µ: µ, x: x(0.02), p: .q(4.138241872117e-3)), ystr, exact: true, digits: 10.3, resultStore: rs, table: t, testCase: "x:0.02µ", field: f1)
        AssertLRE(marcum_inverse(µ: µ, x: x(0.03), p: .q(0.04000364971081)), ystr, exact: true, digits: 11.4, resultStore: rs, table: t, testCase: "x:0.03µ", field: f1)
        AssertLRE(marcum_inverse(µ: µ, x: x(0.04), p: .q(0.191650654805848)), ystr, exact: true, digits: 11.7, resultStore: rs, table: t, testCase: "x:0.04µ", field: f1)
        AssertLRE(marcum_inverse(µ: µ, x: x(0.05), p: .q(0.498535453743169)), ystr, exact: true, digits: 11.8, resultStore: rs, table: t, testCase: "x:0.05µ", field: f1)
        AssertLRE(marcum_inverse(µ: µ, x: x(0.06), p: .p(0.1964796269915073)), ystr, exact: true, digits: 11.6, resultStore: rs, table: t, testCase: "x:0.06µ", field: f1)
        AssertLRE(marcum_inverse(µ: µ, x: x(0.07), p: .p(0.04434265824612003)), ystr, exact: true, digits: 11.5, resultStore: rs, table: t, testCase: "x:0.07µ", field: f1)
        AssertLRE(marcum_inverse(µ: µ, x: x(0.08), p: .p(5.526239087335513e-3)), ystr, exact: true, digits: 10.4, resultStore: rs, table: t, testCase: "x:0.08µ", field: f1)
        AssertLRE(marcum_inverse(µ: µ, x: x(0.09), p: .p(3.750276163593746e-4)), ystr, exact: true, digits: 9.7, resultStore: rs, table: t, testCase: "x:0.09µ", field: f1)
        AssertLRE(marcum_inverse(µ: µ, x: x(0.10), p: .p(1.386276448162126e-5)), ystr, exact: true, digits: 9.1, resultStore: rs, table: t, testCase: "x:0.10µ", field: f1)
    }
    ...
    func testMarcumExtremeTail() {
        ...
        AssertLRE(marcum_inverse(µ: 5, x: 150, p: .p(1.215915354045e-23)), "30.00000000000", resultStore: rs, table: t, testCase: "µ:5,x:150,y:30", field: f1)
        AssertLRE(marcum_inverse(µ: 1, x: 75, p: .p(3.287840255874e-30)), "0.5000000000000", resultStore: rs, table: t, testCase: "µ:1,x:75,y:0.5", field: f1)
        AssertLRE(marcum_inverse(µ: 2, x: 100, p: .p(1.557081489535e-35)), "2.000000000000", resultStore: rs, table: t, testCase: "µ:2,x:100,y:2", field: f1)
        AssertLRE(marcum_inverse(µ: 10, x: 100, p: .p(5.152185145235e-48)), "1.000000000000", resultStore: rs, table: t, testCase: "µ:10,x:100,y:1", field: f1)
    ...
    func testMarcum() {
        ...
        AssertLRE(marcum_inverse(µ: 11.5, x: 15.3, p: .p(0.2948691834572695)), "23", exact: true, digits: 13.9, resultStore: rs, table: tm, testCase: "µ:11.5,x:15.3,y:23", field: f1)
        ...
        AssertLRE(marcum_inverse(µ: 11.5, x: 15.3, p: .p(0.6555891257392535)), "29", exact: true, digits: 11.4, resultStore: rs, table: tm, testCase: "µ:11.5,x:15.3,y:29", field: f1)

        // p recursion
        AssertLRE(marcum(µ: 25, x: 35, y: 49).p, "0.1258610027087132", digits: 13.7, resultStore: rs, table: tm, testCase: "µ:25,x:35,y:49", field: f)
        AssertLRE(marcum_inverse(µ: 25, x: 35, p: .p(0.1258610027087132)), "49", exact: true, resultStore: rs, table: tm, testCase: "µ:25,x:35,y:49", field: f1)

        // q recursion
        AssertLRE(marcum(µ: 25, x: 35, y: 65).p, "0.7079055833201373", digits: 14.0, resultStore: rs, table: tm, testCase: "µ:25,x:35,y:65", field: f)
        AssertLRE(marcum_inverse(µ: 25, x: 35, p: .p(0.7079055833201373)), "65", exact: true, digits: 14.5, resultStore: rs, table: tm, testCase: "µ:25,x:35,y:65", field: f1)
    }
    ...
    func testInverseMarcum() {
        ...
        AssertLRE(marcum_inverse(µ: 15.3, x: 11.5, p: .p(1e-10)), "3.26354", resultStore: rs, table: t, testCase: "p:1e-10", field: f1)
        AssertLRE(marcum_inverse(µ: 15.3, x: 11.5, p: .p(1e-20)), "0.690816", resultStore: rs, table: t, testCase: "p:1e-20", field: f1)
        AssertLRE(marcum_inverse(µ: 15.3, x: 11.5, p: .p(1e-30)), "0.15206", resultStore: rs, table: t, testCase: "p:1e-30", field: f1)

        AssertLRE(marcum_inverse(µ: 15.3, x: 11.5, p: .q(1e-10)), "83.7808", resultStore: rs, table: t, testCase: "q:1e-10", field: f1)
        AssertLRE(marcum_inverse(µ: 15.3, x: 11.5, p: .q(1e-20)), "122.571", resultStore: rs, table: t, testCase: "q:1e-20", field: f1)
        AssertLRE(marcum_inverse(µ: 15.3, x: 11.5, p: .q(1e-30)), "157.415", digits: 5.3, resultStore: rs, table: t, testCase: "q:1e-30", field: f1)
    }
